...
**WEB SEARCH CITATION REQUIREMENTS:** When referencing web pages retrieved from web search tools, **always include citations** in the response. Citations must be provided as inline Markdown links at the end of the relevant sentence or paragraph, using the following format:

...
/// <summary>
/// Represents the design-time implementation of the <c>DocumentsViewViewModel</c>.
/// Provides mock data and commands to aid in the design and development of the Agents View interface.
/// </summary>
public class DesignDocumentsViewViewModel : ToolsViewViewModel
{
    /// <summary>
    ...
    /// </summary>
    public DesignDocumentsViewViewModel() : base(NullLogger<ToolsViewViewModel>.Instance, new NoOpNavigationService(), new NoOpConfigurationService())
    {

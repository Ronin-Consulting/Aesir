...
using IConfigurationService = Aesir.Infrastructure.Services.IConfigurationService;
using ModelLocationDescriptor = Aesir.Infrastructure.Services.ModelLocationDescriptor;
using LoadPdfRequest = Aesir.Modules.Documents.Models.LoadPdfRequest;
using LoadImageRequest = Aesir.Modules.Documents.Models.LoadImageRequest;
using LoadTextFileRequest = Aesir.Modules.Documents.Models.LoadTextFileRequest;

namespace Aesir.Modules.Documents.Services.DocumentCollections;
...
public class ConversationDocumentCollectionService : IConversationDocumentCollectionService
{
    ...
    /// </remarks>
    private readonly Aesir.Modules.Documents.Services.DocumentLoaders.IPdfDataLoaderService<Guid, AesirConversationDocumentTextData<Guid>> _pdfDataLoader;
    ...
    /// </remarks>
    private readonly Aesir.Modules.Documents.Services.DocumentLoaders.IImageDataLoaderService<Guid, AesirConversationDocumentTextData<Guid>> _imageDataLoader;
    ...
    /// </remarks>
    private readonly Aesir.Modules.Documents.Services.DocumentLoaders.ITextFileLoaderService<Guid, AesirConversationDocumentTextData<Guid>> _textFileLoader;
    ...
    public ConversationDocumentCollectionService(
        ...
        Aesir.Modules.Documents.Services.DocumentLoaders.IPdfDataLoaderService<Guid, AesirConversationDocumentTextData<Guid>> pdfDataLoader,

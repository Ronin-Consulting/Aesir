...
namespace Aesir.Modules.Mcp.Services;
...
public class McpServerService(ILogger<McpServerService> logger) : IMcpServerService
{
    ...
    public async Task<IEnumerable<AesirMcpServerTool>> GetMcpServerToolsAsync(Aesir.Infrastructure.Models.AesirMcpServer mcpServer)
    {

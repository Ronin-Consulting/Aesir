...
namespace Aesir.Modules.Chat.Services;
...
public class ChatHistoryService(ILogger<ChatHistoryService> logger, IDbContext dbContext) : IChatHistoryService
{
    ...
    /// </returns>
    public async Task<IEnumerable<AesirChatSessionBase>> GetChatSessionsByFilenameAsync(string fileName)
    {
    ...
    public async Task<IEnumerable<AesirChatSessionBase>> SearchChatSessionsAsync(string searchTerm, string userId)
    {

...
[Migration(20251214000002, "Fix full-text search index JSON path to use PascalCase and correct filter operator")]
public class Migration20251214000002 : Migration
{
    public override void Up()
    {
        // Drop the existing index (has incorrect lowercase JSON paths)

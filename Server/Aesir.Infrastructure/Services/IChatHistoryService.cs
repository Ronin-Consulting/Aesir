...
public interface IChatHistoryService
{
    ...
    Task UpsertChatSessionAsync(AesirChatSessionBase chatSession);
    ...
    Task<AesirChatSessionBase?> GetChatSessionAsync(Guid id);
    ...
    Task<IEnumerable<AesirChatSessionBase>> GetChatSessionsAsync(string userId);
    ...
    /// <returns>A task representing the asynchronous operation that returns a collection of chat sessions.</returns>
    Task<IEnumerable<AesirChatSessionBase>> GetChatSessionsByFilenameAsync(string fileName);
    ...
    /// <returns>A task representing the asynchronous operation that returns a collection of chat sessions.</returns>
    Task<IEnumerable<AesirChatSessionBase>> GetChatSessionsAsync(string userId, DateTimeOffset from, DateTimeOffset to);
    ...
    Task<IEnumerable<AesirChatSessionBase>> SearchChatSessionsAsync(string searchTerm, string userId);

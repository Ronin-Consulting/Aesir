...
namespace Aesir.Orchestration.Services;
...
public class KernelFunctionLibrary<TKey, TRecord>(
    ...
    where TKey : notnull
    where TRecord : Aesir.Infrastructure.Models.AesirTextData<TKey>
{
    ...
    public KernelFunction GetSummarizeConversationDocumentFunction(string? conversationId)
    {
        ...
        var plugin =
            new SummarizeConversationDocumentPlugin<Guid, Aesir.Infrastructure.Models.AesirConversationDocumentTextData<Guid>>(
                vectorStoreCollection as VectorStoreCollection<Guid, Aesir.Infrastructure.Models.AesirConversationDocumentTextData<Guid>> ??
    ...
    /// </exception>
    public async Task<KernelFunction> GetMcpServerToolFunctionAsync(Aesir.Infrastructure.Models.AesirMcpServer mcpServer, string toolName)
    {
...
internal class SummarizeConversationDocumentPlugin<TKey, TRecord>(
    ...
    where TKey : notnull
    where TRecord : Aesir.Infrastructure.Models.AesirConversationDocumentTextData<TKey>
{

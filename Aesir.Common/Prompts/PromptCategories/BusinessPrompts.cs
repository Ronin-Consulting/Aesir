...
You should consider this when responding to user questions, especially for time-sensitive information.
...
- You can execute tools more than once if needed to gather additional information, refine results, or chain searches (e.g., use document search first, then web if more context is required). However, minimize executions for edge efficiency.  
